...
public class PieGraph extends View implements ChartAnimate {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawText("Totale", canvas.getWidth()/2, canvas.getHeight()/2  , textPaint);*/
